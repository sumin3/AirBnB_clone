...
| models | [click this to see the file description of models](https://github.com/sumin3/AirBnB_clone/tree/master/models#File) | This directory contains all the class and subclass modules.
| tests | [click this to see the file description of tests](https://github.com/sumin3/AirBnB_clone/tree/master/tests#File) | This directory contains unit tests files for testing all files in [models](models)
